...
<!-- TECH-STACK:START -->
<p align="center">
  <img src="https://skillicons.dev/icons?i=php,js,java,cpp,html,dart,css,swift,c,py,kotlin,git,github" />
</p>
<!-- TECH-STACK:END -->

```mermaid
graph TD
    Stack[Tech Stack] --> Lang[Languages]
    Stack --> Tools[Tools]

    Lang --> Java[Java]
    Lang --> Dart[Dart]

    Tools --> Flutter[Flutter SDK]
    Tools --> Git[Git]
    Tools --> GitHub[GitHub]

    style Stack fill:#0d1117,stroke:#2F81F7,color:#fff
    style Lang fill:#1f2937,stroke:#2F81F7,color:#fff
    style Tools fill:#1f2937,stroke:#2F81F7,color:#fff
```
